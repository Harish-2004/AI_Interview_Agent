...
* Running `docker compose up -d` simply **starts existing containers** in the background in less than 2 seconds.
* You do NOT need to run `alembic upgrade head` every time—only when database tables/schemas change!
...
```
* **Web Application:** [http://localhost:3000/frontend/](http://localhost:3000/frontend/)
